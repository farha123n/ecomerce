						...
						<div class="resp-tabs-container hor_1">
							<div>
								<form action="{{ route('submit_contact') }}" method="post">
									@csrf
									<input type="text" value="Name" name="user_name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name';}" required="">
									<input type="email" value="Email" name="user_email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
									<input type="text" value="Contact Number" name="user_contact" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Contact Number';}" required="">
									<textarea name="user_message" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Message...';}" required="">Message...</textarea>
